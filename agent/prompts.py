...
# from agent.clustering import ViolationCluster
...
# 4. If a fix requires knowing what an image depicts, what a link leads to, or \
# what a control does, and the markup does not tell you, put it in `deferred` \
# with a reason. Deferring is a correct answer, not a failure.
...
#     guidance = DECORATIVE_IMAGE_GUIDANCE if cluster.needs_human_judgement else ""
#     nodes_text = "\n\n".join(node_blocks)
