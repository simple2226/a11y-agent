...
# Check data worth carrying past the trim. axe already computed these, and for
# colour contrast they are the whole fix: given the foreground, the background
# and the ratio required, the compliant colour is arithmetic, not judgement.
# Throwing this away and asking a model to guess a colour was wasteful and
# unreliable.
KEPT_CHECK_DATA = ("fgColor", "bgColor", "contrastRatio", "expectedContrastRatio",
                   "fontSize", "fontWeight")


def _check_data(node: dict) -> dict:
    """Flatten the useful fields out of axe's any/all/none check results."""
    collected: dict = {}
